        ...
        <div class="col-md-12">
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    @endif
                    <form class="form-horizontal" id="form-property" action="/koordinator/add" method="POST">
                        @csrf
                        <div class="box-group" id="accordion">
                            <div class="panel box">
                                <!-- BASIC INFORMATION -->
                                @include('partials.forms.koordinator.basicinformation')
