        ...
        <div class="col-md-12">
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    {!! Form::model($pend,  ['url'=>array( '/koordinator/update', $pend->id), 'method' => 'patch','enctype' => 'multipart/form-data', 'files' => true]) !!}
                    ...
                    <br>
                    <div class="form-group">
                      {!! Form::label('kabkot', 'Kab / Kota', ['class'=>'control-label col-md-2']) !!}
                      <div class="col-md-10">
                        {!! Form::text('kabkot', null, ['class'=>'form-control', 'Placeholder'=>'']) !!}
                        {!! $errors->has('kabkot')?$errors->first('kabkot'):'' !!}
                      </div>
                    </div>
                    <br>
                    <br>
                    <div class="form-group">
                      {!! Form::label('tps', 'TPS', ['class'=>'control-label col-md-2']) !!}
                      <div class="col-md-10">
                        {!! Form::text('tps', null, ['class'=>'form-control', 'Placeholder'=>'']) !!}
                        {!! $errors->has('tps')?$errors->first('tps'):'' !!}
                      </div>
                    </div>
                    <br>
                    <br>
                    <div class="form-group">
                      {!! Form::label('telephone', 'Telp.', ['class'=>'control-label col-md-2']) !!}
                      <div class="col-md-10">
