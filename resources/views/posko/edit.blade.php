        ...
        <div class="col-md-12">
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    {!! Form::model($posk,  ['url'=>array( '/posko/update', $posk->id), 'method' => 'patch','enctype' => 'multipart/form-data', 'files' => true]) !!}
                    
                    <div class="form-group">
                      {!! Form::label('name', ' Nama Koordinator', ['class'=>'control-label col-md-2']) !!}
                      <div class="col-md-10">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        {!! Form::text('lokasi', null, ['class'=>'form-control', 'Placeholder'=>'']) !!}
                    ...
                    <br>
                    <div class="form-group">
                      {!! Form::label('penjwb', 'Penagnggung Jawab', ['class'=>'control-label col-md-2']) !!}
                      <div class="col-md-10">
                        {!! Form::text('penjwb', null, ['class'=>'form-control', 'Placeholder'=>'']) !!}
                        {!! $errors->has('penjwb')?$errors->first('penjwb'):'' !!}
                      </div>
                    </div>
                    <br>
                    <br>
                    <div class="form-group">
                      {!! Form::label('jmlh_dpt', 'Jumlah Dpt', ['class'=>'control-label col-md-2']) !!}
                      <div class="col-md-10">
                        {!! Form::text('jmlh_dpt', null, ['class'=>'form-control', 'Placeholder'=>'']) !!}
                        {!! $errors->has('jmlh_dpt')?$errors->first('jmlh_dpt'):'' !!}
                      </div>
                    </div>
                    <br>
                    <br>
