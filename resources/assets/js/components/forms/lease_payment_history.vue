<template>
    <div style="margin:20px;">
        ...
        <div class="row" v-for="(row, i) in shared.paymentHistory" v-bind:key="i">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <indate :id="`row_due_date_${i}`" :bind-to="`shared.paymentHistory[${i}].due_date`"></indate>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6">
                <indate :id="`row_paid_date_${i}`" :bind-to="`shared.paymentHistory[${i}].paid_date`"></indate>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6">
...
<script>
    ...
    export default {
        ...
        methods: {
            addRow() {
                this.shared.paymentHistory.push({total: 0, due_date: '', paid_date: '', note:''});
            },
            deleteRow(key) {
                let newRows = [];
